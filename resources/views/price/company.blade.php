...
@section('content')
    <section id="detail" style="margin-top: 100px" class="py-5">
        ...
        <div class="header-projecr text-center">
            <h2 class="fw-bold">Price List Company Profile </h2>
        </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6 " data-aos="fade-up" data-aos-delay="100">
                        <div class="box  featured">
                            ...
                            <div class="btn-wrap">
                                <a href="#" class="btn-buy" style="background-color: #4CAF50; color: white">Buy
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="box featured">
                            ...
                            <div class="btn-wrap">
                                <a style="background-color: #FC9236; color: white" href="#" class="btn-buy">Buy
                                    Now</a>
                            </div>
                        </div>
                    </div>
