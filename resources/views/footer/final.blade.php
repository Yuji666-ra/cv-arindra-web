        ...
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="row py-2" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/tutorial/final/tutorial1.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/tutorial/final/tutorial2.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/tutorial/final/tutorial3.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                        <div class="konten-project">
            ...
            <div class="row py-2" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/tutorial/final/tutorial4.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                        <div class="konten-project-center">
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/tutorial/final/tutorial5.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                        <div class="konten-project">
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/tutorial/final/tutorial6.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                        <div class="konten-project">
