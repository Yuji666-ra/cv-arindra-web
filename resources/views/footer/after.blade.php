...
@section('content')
    ...
    <div class="cover" style="margin-bottom: 50px">
        <h1>Tutorial Adobe After Effect</h1>
        <p>Lihat Selengkapnya Tutorial Adobe After Effect Dari Kami</p>
    </div>
    <section id="services" class="services section-bg">
        <div class="container" style="margin-bottom: 80px" style="margin-top: 80px">
