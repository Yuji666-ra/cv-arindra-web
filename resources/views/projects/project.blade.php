    ...
    <section id="detail" style="margin-top: 100px" class="py-5">
        <div class="container col-xxl-8">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="konten-project">
                            ...
                            <p class="text-secondary">CV. Arindra Production di berikan kesempatan untuk menghandle dan
                                mengorganize salah satu acara bergengsi yaitu Spemma Esport Competition SMP Muhammadiyah 5 Surabaya,
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        ...
                        <div class="konten-project">
                            ...
                            <p class="text-secondary">CV. Arindra Production di berikan kesempatan untuk menghandle salah satu
                                acara bergengsi bersama Otoritas Jasa Keuangan Surabaya yaitu Sosialisasi Ketentuan Perbankan.
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card border-0">
                        ...
                        <div class="konten-project">
                            ...
                            <p class="text-secondary">CV. Arindra Production di berikan kesempatan untuk mendokumentasikan
                                ...
                                SMP Muhammadiyah 5 Surabaya, hasilnya cukup memuaskan dan client sangat puas dengan pelayanan kami.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card border-0">
                        ...
                        <div class="konten-project">
                            ...
                            <p class="text-secondary">CV. Arindra Production di berikan kesempatan untuk menghandle salah satu acara
                                tahunan bergengsi yaitu 17 agustus 2022 SMP Muhammadiyah 5 Surabaya, hasilnya cukup memuaskan dan
            ...
            <div class="row py-5" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card border-0">
                        ...
                        <div class="konten-project">
                            ...
                            <p class="text-secondary">CV. Arindra Production di berikan kesempatan untuk menghandle salah satu
                                acara bergengsi bersama OCV. Arindra Production di percaya untuk menghandle live streaming acara
                                Talkshow Aerospace Career Bamantara Eepisat dengan bintang tamu Vina Mulyana yang begitu meriah,
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        ...
                        <div class="konten-project">
                            ...
                            <p class="text-secondary">CV. Arindra Production di percaya untuk menghandle live streaming acara
                ...
                <div class="col-lg-4">
                    <div class="card border-0">
                        <img src="{{ asset('assets/images/projects/project-9.jpg') }}" class="img-fluid mb-3" height="350"
                            width="350" alt="">
                        <div class="konten-project">
                            <p class="mb-3 text-secondary">28/8/2022</p>
                            <h5 class="fw-bold mb-3">IT Telkom Surabaya Esport Competition</h5>
                            <p class="text-secondary">CV. Arindra Production di percaya untuk menghandle live streaming acara IT Telkom Surabaya
                                Esport Competition yang begitu meriah, hasilnya cukup memuaskan dan pihak client sangat puas dengan pelayanan kami.
                            </p>
                        </div>
                    </div>
                </div>
